...
//' @export
// [[Rcpp::export]]
Rcpp::List two_species_mosquito_population_model_with_comp_k_part(int start_time, int end,
                                                                  ...
                                                                  double competition_parameter_two_on_one, double competition_parameter_one_on_two,
                                                                  double species_one_static_K, double species_two_static_K,
                                                                  double threshold_dd_1, double threshold_dd_2,
                                                                  double max_K_1, double max_K_2) {
      ...
      if (j == 0) {
        ...
        if (mortality_density_function_species_one == "linear") {
          ...
          if (M_2 < threshold_dd_1) {
            ...
            muE_1 = muE0_1 * (1 + ((E_1 + L_1 + competition_parameter_two_on_one * E_2 + competition_parameter_two_on_one * L_2) / (K_1_rainfall + K_1_static)));
            muL_1 = muL0_1 * (1 + lambda_1 * (((E_1 + L_1 + competition_parameter_two_on_one * E_2 + competition_parameter_two_on_one * L_2) / (K_1_rainfall + K_1_static))));
